    ...
    <div class="min-h-screen bg-slate-50/50 pt-28 pb-20 text-slate-800" x-data="{
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6">
            ...
            <nav class="flex items-center gap-2 text-xs font-semibold text-slate-500 mb-4">
                <a href="{{ route('perusahaan.dashboard') }}" class="hover:text-[#00509d] transition">Beranda</a>
                <i class="ph ph-caret-right text-[10px]"></i>
                <a href="{{ route('perusahaan.event.index') }}" class="hover:text-[#00509d] transition">Event</a>
                <i class="ph ph-caret-right text-[10px]"></i>
