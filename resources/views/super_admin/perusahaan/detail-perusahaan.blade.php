        ...
        <header class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 bg-white p-4 sm:p-5 rounded-2xl border border-slate-100 shadow-sm">
            ...
            <div class="flex items-center gap-2.5 w-full sm:w-auto justify-end flex-wrap">
                ...
                <a href="{{ route('superadmin.lowongan.create.form', $perusahaan->id) }}"
                   class="inline-flex items-center gap-1.5 bg-[#00509d] hover:bg-[#003d7a] text-white text-xs font-semibold px-3.5 py-2 rounded-xl transition shadow-sm">
                ...
                <a href="{{ route('superadmin.edit.user', $perusahaan->user->id) }}"
                   class="inline-flex items-center gap-1.5 border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 text-xs font-semibold px-3.5 py-2 rounded-xl transition">
                ...
                <form action="{{ route('superadmin.delete.akun', $perusahaan->user->id) }}" method="POST"
                    ...
                    @method('DELETE')
                    <button type="submit"
                            class="inline-flex items-center gap-1.5 bg-rose-50 hover:bg-rose-100 text-rose-600 border border-rose-200 text-xs font-semibold px-3.5 py-2 rounded-xl transition">
                    ...
                    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-sm font-bold text-slate-800 uppercase tracking-wider flex items-center gap-2">
                                ...
                                Lowongan Kerja ({{ $perusahaan->lowonganPerusahaans->count() }})
                            </h3>
                            <a href="{{ route('superadmin.lowongan.create.form', $perusahaan->id) }}"
                               class="text-xs font-semibold text-[#00509d] hover:underline flex items-center gap-1">
                                <i class="ph ph-plus text-xs"></i> Tambah Baru
                            </a>
                        </div>
