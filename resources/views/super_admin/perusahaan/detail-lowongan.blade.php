            ...
            <div class="flex flex-col sm:flex-row items-center sm:items-start gap-5 p-6 border-b border-slate-100">
                ...
                <div class="flex items-center gap-2 flex-shrink-0">
                    <a href="{{ route('superadmin.lowongan.edit.form', $lowongan->id) }}"
                       title="Edit Lowongan"
                       class="inline-flex items-center gap-1.5 border border-slate-200 text-slate-600 hover:bg-[#00509d] hover:text-white hover:border-[#00509d] text-xs font-semibold px-3 py-2 rounded-xl transition">
                    ...
                    <form action="{{ route('superadmin.lowongan.destroy', $lowongan->id) }}" method="POST"
                        ...
                        <button type="submit"
                                ...
                                class="inline-flex items-center gap-1.5 border border-rose-300 text-rose-600 hover:bg-rose-600 hover:text-white hover:border-rose-600 text-xs font-semibold px-3 py-2 rounded-xl transition">
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-semibold text-slate-800">{{ $lowongan->published_at }}</p>
                    </div>
                </div>
