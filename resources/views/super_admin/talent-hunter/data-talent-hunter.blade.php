            ...
            <table class="w-full min-w-[800px] text-left border-collapse">
                <thead class="text-center bg-orange-500 text-white">
                    <tr>
                        ...
                        <th class="p-4 sm:p-7 font-medium">Posisi</th>
                ...
                <tbody class="text-center">
                    @forelse ($talentHunter as $th)
                        <tr class="border-b border-gray-300">
                            ...
                            <td class="px-2 sm:px-4 py-2 break-words">{{ $th->alamat }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-4 py-6 text-gray-500">Tidak ada data talent hunter</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
