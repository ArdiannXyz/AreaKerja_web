        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            ...
            <div class="relative w-full sm:w-80" x-data="{
                ...
                recommendations: [
                    ...
                    { label: 'Surabaya', category: 'Kota', icon: 'ph-map-pin' },
                    { label: 'Bandung', category: 'Kota', icon: 'ph-map-pin' },
                ],
                get filtered() {
                ...
                <form x-ref="talentHunterForm" action="{{ route('superadmin.talent-hunter') }}" method="GET" autocomplete="off" class="flex items-center w-full">
                    <div class="flex items-center w-full bg-slate-100 rounded-xl overflow-hidden border border-slate-200 focus-within:bg-white focus-within:border-[#00509d] focus-within:ring-2 focus-within:ring-[#00509d]/20 transition">
                        ...
                        <template x-if="query.length > 0">
                            <a href="{{ route('superadmin.talent-hunter') }}"
                               @click.prevent="query = ''; open = false; window.location.href = '{{ route('superadmin.talent-hunter') }}';"
                        ...
                        <tr class="border-b border-gray-300">
                            ...
                            <td class="px-2 sm:px-4 py-2">
                                <a href="{{ route('superadmin.talent-hunter.detail', $th->id) }}"
                                    class="bg-blue-700 hover:bg-blue-800 text-xs sm:text-sm text-white px-3 sm:px-4 py-1 sm:py-2 rounded-lg inline-block whitespace-nowrap">
                                    View
                                </a>
                            </td>
                        </tr>
