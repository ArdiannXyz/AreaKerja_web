                ...
                <div class="flex items-center justify-between mb-10">
                    <div class="flex items-center gap-2">
                        ...
                        <div class="flex flex-col sm:flex-row items-center sm:items-start gap-4">
                            <!-- Upload Button -->
                            <label
                                class="flex items-center justify-center sm:justify-start gap-2 px-4 py-2 text-md border-2 border-blue-800 bg-blue-700 hover:bg-blue-800 text-white rounded-md cursor-pointer w-full sm:w-auto">
                            ...
                            <button type="button" id="removeButton"
                                class="flex items-center justify-center sm:justify-start gap-2 px-4 py-2 text-md border-2 border-blue-800 text-blue-800 rounded-md hover:bg-gray-100 w-full sm:w-auto mt-2 sm:mt-0">
                                <svg width="20" height="20" viewBox="0 0 11 12" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
    ...
    @endswitch">
                ...
                @else
                    ...
                    <div class="mb-4">
                        ...
                        <button type="button"
                            class="w-full flex justify-between items-center bg-blue-700 text-white px-4 py-2 rounded-lg hover:bg-blue-800"
            ...
            @else data-modal-target="create_skillmodal" data-modal-toggle="create_skillmodal" @endif>
                ...
                <div class="flex flex-col sm:flex-row justify-center items-center gap-4 mt-4">
                    <button type="submit"
                        class="w-full sm:w-auto bg-blue-800 text-white font-medium px-10 py-2 rounded-md hover:bg-blue-700 border border-blue-800 transition">
                        Upload
                    </button>
                    <a href="{{ route('superadmin.pelamar') }}"
                        class="w-full sm:w-auto bg-white text-blue-800 font-medium px-12 py-2 rounded-md hover:bg-gray-100 border border-blue-800 transition">
                        Kembali
                    </a>
                </div>
