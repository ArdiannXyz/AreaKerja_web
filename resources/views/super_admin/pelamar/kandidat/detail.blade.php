        ...
        <div class="flex justify-between items-center mb-6 flex-col sm:flex-row gap-4 sm:gap-0 border-b border-gray-100 pb-5">
            <div class="flex items-center gap-3">
                <a href="{{ route('superadmin.pelamar') }}"
                    class="p-2 rounded-xl border border-gray-200 hover:bg-gray-50 text-gray-600 transition">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500">Informasi profil dan kurikulum vitae kandidat</p>
                </div>
            </div>
        ...
        <div class="max-w-6xl mx-auto bg-white rounded-xl shadow-md border-2 border-gray-400 p-6 relative">
            ...
            <div class="grid grid-cols-1 space-y-3 mx-auto max-w-72 mt-20">
                ...
                <a href="{{ route('cv.preview', $data->id) }}"
                    class="bg-blue-700 hover:bg-blue-600 text-white px-6 py-2 rounded-lg text-center transition duration-300">
                    Preview
                </a>
