<!-- Main modal -->
<div id="show-skill2" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-sm">
                ...
                @foreach ($pelamar->skill as $skill)
                    <div class="mb-6">
                        <div class="flex justify-between">
                            ...
                            <a href="{{ route('superadmin.skill.edit', $skill->id) }}">
            ...
            <div class="flex justify-end mr-6">
                <button data-modal-target="create_skillmodal2" data-modal-toggle="create_skillmodal2"
                    data-modal-hide="show-skill2"
