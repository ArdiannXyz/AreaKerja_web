<!-- Main modal -->
<div id="show-kerja2" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-sm">
                ...
                @foreach ($pelamar->pengalaman_kerja as $kerja)
                    <div class="mb-6">
                        <div class="flex justify-between">
                            <h3 class="font-semibold text-gray-800 text-md ml-5 mt-4">
                                {{ $kerja->posisi_pekerjaan }} - {{ $kerja->nama_perusahaan }} <br>
                                ({{ $kerja->tahun_awal }} - {{ $kerja->tahun_akhir }})
                            </h3>
                            <a href="{{ route('superadmin.kerja.edit', $kerja->id) }}">
                        ...
                        <div class="flex gap-2 mt-2">
                            <!-- Tombol Hapus -->
                            <form action="{{ route('superadmin.kerja.destroy', $kerja->id) }}" method="POST"
            ...
            <div class="flex justify-end mr-6">
                <button data-modal-target="create_kerjamodal2" data-modal-toggle="create_kerjamodal2"
                    data-modal-hide="show-kerja2" type="button"
