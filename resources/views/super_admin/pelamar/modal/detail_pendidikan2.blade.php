<!-- Main modal -->
<div id="show-pendidikan2" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow-sm">
            ...
            <div
                ...
                <button type="button"
                    ...
                    data-modal-hide="show-pendidikan2">
                ...
                @foreach ($pelamar->riwayat_pendidikan as $pend)
                    <div class="mb-6 mt-4">
                        <div class="flex justify-between ml-4">
                            ...
                            <a href="{{ route('superadmin.pendidikan.edit', $pend->id) }}">
                        ...
                        <div class="flex gap-2 mt-2 ml-4">
                            <form action="{{ route('superadmin.pendidikan.destroy', $pend->id) }}" method="POST"
                                onsubmit="return confirm('Yakin hapus data pendidikan ini?')">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
                                    class="px-3 py-1 bg-red-500 text-white rounded-lg text-sm hover:bg-red-600 font-medium">
                                    Hapus
                                </button>
                            </form>
                        </div>
            ...
            <div class="flex justify-end mr-6">
                <button data-modal-target="create_pendidikanmodal2" data-modal-toggle="create_pendidikanmodal2"
                    data-modal-hide="show-pendidikan    2" type="button"
