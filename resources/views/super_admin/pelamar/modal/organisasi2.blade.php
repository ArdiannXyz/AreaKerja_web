<!-- Main modal -->
<div id="create_organisasimodal2" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div
                ...
                <button type="button"
                    ...
                    data-modal-hide="create_organisasimodal2">
            ...
            <div class="max-w-lg mx-auto bg-white shadow-lg rounded-xl p-6">
                <form
                    action="{{ isset($organisasi)
                        ? route('superadmin.organisasi.update', $organisasi->id)
                        : route('superadmin.organisasi.update') }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" rows="4"
                            class="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600"></textarea>
                    </div>
