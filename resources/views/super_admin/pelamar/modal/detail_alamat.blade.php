<!-- Main modal -->
<div id="show-alamat" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-sm">
                ...
                @foreach ($pelamar->alamat_pelamar as $almt)
                    <div class="mb-6">
                        <div class="flex justify-between">
                            ...
                            <a href="{{ route('superadmin.alamat.edit', $almt->id) }}">
                        ...
                        <div class="flex gap-2 mt-2">
                            <!-- Tombol Hapus -->
                            <form action="{{ route('superadmin.alamat.destroy', $almt->id) }}" method="POST"
            ...
            <div class="flex justify-end mr-6">
                <button data-modal-target="create_alamatmodal2" data-modal-toggle="create_alamatmodal2"
                    data-modal-hide="show-alamat" type="button"
