<!-- Main modal -->
<div id="create_skillmodal2" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div
                ...
                <button type="button"
                    ...
                    data-modal-toggle="create_skillmodal2">
            ...
            <div class="max-w-lg mx-auto bg-white shadow-lg rounded-xl p-6">
                <form
                    action="{{ isset($skill) ? route('superadmin.skill.update', $skill->id) : route('superadmin.skill.update') }}"
                    method="POST">
                    @csrf
                    @method('PUT')
