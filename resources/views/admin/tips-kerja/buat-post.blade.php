    ...
    <main class="flex-1 p-4 sm:p-6 sm:ml-64 bg-slate-50/70 min-h-screen" x-data="{ openNotif: false, openAllNotif: false }">
        ...
        <header class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/80 shadow-xs">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xs text-slate-400 font-medium">Tips Kerja / <span class="text-slate-600 font-semibold">Buat Baru</span></p>
                    <h1 class="text-lg sm:text-xl font-bold text-slate-900 tracking-tight leading-tight">Buat Post Tips Kerja</h1>
                </div>
            </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200/80 shadow-xs p-6 sm:p-8 max-w-4xl mx-auto">
            <form action="{{ route('admin.tips-kerja.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" placeholder="Tulis judul artikel yang menarik..."
                ...
                <div>
                    ...
                    <p class="text-[11px] text-slate-400 mt-1.5 font-medium">Format: PNG, JPG, JPEG, WEBP, atau PDF. Maksimal 10MB.</p>
                </div>
                ...
                <div>
                    ...
                    <textarea id="editor" name="content" class="w-full border border-slate-200 rounded-xl">{{ old('content') }}</textarea>
                </div>
