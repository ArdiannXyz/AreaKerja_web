        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 mb-6">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2.5 text-xs text-slate-500 mt-1 flex-wrap">
                            ...
                            @if (!empty($pelamar->divisi))
                                <span>•</span>
                                <span class="text-[#00509d] font-semibold">
                ...
                <div class="flex items-center gap-2.5 flex-wrap pt-2 lg:pt-0 border-t lg:border-t-0 border-slate-100">
                    {{-- Lulus --}}
                    <form action="{{ route('calon.lulus', $pelamar->id) }}" method="POST" class="inline"
                    ...
                    {{-- Gugur --}}
                    <form action="{{ route('calon.gugur', $pelamar->id) }}" method="POST" class="inline"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div class="lg:col-span-5 space-y-6">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                    ...
                    <form method="POST" action="{{ route('calon.update', $pelamar->id) }}" class="space-y-4">
                        @csrf
            ...
            <div class="lg:col-span-7 space-y-6">
                ...
                {{-- Pendidikan --}}
                @if ($pelamar->riwayat_pendidikan && $pelamar->riwayat_pendidikan->isNotEmpty())
                    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                        <div class="flex items-center gap-3 pb-4 mb-4 border-b border-slate-100">
                ...
                {{-- Keahlian --}}
                @if ($pelamar->skill && $pelamar->skill->isNotEmpty())
                    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                        <div class="flex items-center gap-3 pb-4 mb-4 border-b border-slate-100">
                            <div class="p-2 rounded-xl bg-amber-50 text-amber-600">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {{-- CV Banner --}}
                <div class="bg-gradient-to-r from-[#003d7a] via-[#00509d] to-slate-800 rounded-2xl p-6 text-white shadow-md flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div class="flex items-center gap-4">
