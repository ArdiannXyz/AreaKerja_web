        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4 pb-4 border-b border-slate-200">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('admin.kandidat') }}"
                    ...
                    title="Kembali ke Data Kandidat">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="flex items-center gap-3 flex-wrap">
                            ...
                            @else
                                <span class="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full text-xs font-semibold bg-blue-50 text-[#00509d] border border-blue-200/80 whitespace-nowrap">
                                    Pelamar
                                </span>
                            @endif
                        </div>
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
                    ...
                    <div class="grid grid-cols-3 gap-2 text-center">
                        ...
                        <div class="bg-slate-50/80 rounded-xl p-2.5 border border-slate-100">
                            ...
                            <span class="text-xs font-semibold text-[#00509d] mt-0.5 block truncate capitalize">
                    ...
                    <div class="space-y-3.5 text-xs">
                        ...
                        @if ($data->mulai_pelatihan || $data->selesai_pelatihan)
                            <div class="flex items-start gap-3 p-2.5 rounded-xl bg-blue-50/50 border border-blue-100">
                                <div class="p-2 rounded-lg bg-white border border-blue-200 text-[#00509d]">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                    </svg>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <span class="text-[11px] font-medium text-[#00509d] block">Masa Pelatihan</span>
                                    <span class="text-xs font-semibold text-slate-800 block">
                                        {{ $data->mulai_pelatihan ? \Carbon\Carbon::parse($data->mulai_pelatihan)->format('d M Y') : '-' }} s/d {{ $data->selesai_pelatihan ? \Carbon\Carbon::parse($data->selesai_pelatihan)->format('d M Y') : '-' }}
                                    </span>
                                </div>
                            </div>
                        @endif
